    ...
    <div>
      ...
      <main className="container mx-auto my-10 px-6">
        <section id="home" className="text-center">
          <div className="text-white bg-gradient-to-tr to-blue-500 from-violet-500">
            <h1 className="text-5xl font-bold mb-6 text-white pt-24">
      ...
      >
        <div className="w-full p-2 flex flex-col justify-center items-center">
          <p>&copy; 2024 Image Wizard. All rights reserved.</p>
